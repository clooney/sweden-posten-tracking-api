PostNord Tracking API - .Net
================================
Use .Net to track PostNord shipments with PostNord Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "RR823990835SE";
                  createTrackingParams.courierCode = "sweden-posten";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "RR068358445SE",
                      courierCode = "sweden-posten"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "RR068358445SE,LE705669034SE";
                  getTrackingResultsParams.courierCode = "sweden-posten";

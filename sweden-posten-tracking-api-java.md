PostNord Tracking API - Java
================================
Use Java to track PostNord shipments with PostNord Tracking API.

Features
--------
- Real-time PostNord tracking.
- Batch PostNord tracking.
- Other features to manage your PostNord tracking.
...
Then, start to track your PostNord shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.swedenposten;
    ...
    public class CreatePostNordTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("RR823990835SE");
                createTrackingParams.setCourierCode("sweden-posten");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreatePostNordTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RR068358445SE");
                createTrackingParams1.setCourierCode("sweden-posten");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("LE705669034SE");
                createTrackingParams2.setCourierCode("sweden-posten");
...
Get status of the shipment:
    ...
    public class GetPostNordTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RR068358445SE,LE705669034SE");
                trackingParams.setCourierCode("sweden-posten");
...
Update a tracking by ID:
    ...
    public class UpdatePostNordTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9d8a3d982f74af09aaa5228e71d9f91b";
